...
# -------------------------------------------------- #
pubtypes=$(psql -tAF"¤" -Upostgres -h "${DBHOST}" -v DEPTID=${DEPTID} -v STARTYEAR=${STARTYEAR} -v ENDYEAR=${ENDYEAR} "${BIBMET_DB}" < marina_norList_pubtype.sql)
...
# -------------------------------------------------- #
data=$(psql -tAF"¤" -Upostgres -h "${DBHOST}" -v DEPTID=${DEPTID} -v STARTYEAR=${STARTYEAR} -v ENDYEAR=${ENDYEAR} "${BIBMET_DB}" < marina_norList_data.sql)
